...
pros::Motor leftMotB(11, pros::E_MOTOR_GEARSET_18, false);
pros::Motor leftMotF(12, pros::E_MOTOR_GEARSET_18, false);

//the right drive train, both reversed
pros::Motor rightMotB(20, pros::E_MOTOR_GEARSET_18, true);
pros::Motor rightMotF(19, pros::E_MOTOR_GEARSET_18, true);

//the fly wheel, with the high speed gearset, one reversed one not.
pros::Motor fly(1, pros::E_MOTOR_GEARSET_06, false);
pros::Motor fly2(2, pros::E_MOTOR_GEARSET_06, false);

//both of the loaders, one reversed one not.
pros::Motor LoadServ(10, pros::E_MOTOR_GEARSET_18, true);
